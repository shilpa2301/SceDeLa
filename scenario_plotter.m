classdef scenario_plotter% < Vehicle
   ...
   methods
       ...
       function plot_scenario( scenario_with_ego_veh, DSD_Scenario, veh_actor_trajectory_params)
    ...
    %'VerticalAxis', 'Y');
              ...
              smoothTrajectory(egoVehicle, veh_actor_trajectory_params.waypoints, veh_actor_trajectory_params.speed);
